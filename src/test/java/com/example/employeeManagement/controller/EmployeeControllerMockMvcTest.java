...
public class EmployeeControllerMockMvcTest {
    ...
    public void getEmployeesTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .get("/employees")
                .accept(MediaType.APPLICATION_JSON).header("Authorization", "Basic dXNlcjpwYXNzd29yZA=="))
                .andDo(print())
    ...
    public void getEmployeeByIdTest() throws Exception {
        ...
        Employee employee1 = new Employee(1L, "vitthal", "kasbe", "vitthalkasbe@okvks", null);
    ...
    public void saveEmployeeTest() throws Exception {
        Employee employee1 = new Employee(null, "vitthal", "kasbe", "vitthalkasbe@okvks", null);
        Employee employee2 = new Employee(1L, "vitthal", "kasbe", "vitthalkasbe@okvks", null);
    ...
    public void updateEmployeeTest() throws Exception {
        Employee employee2 = new Employee(2L, "vitthal", "kasbe", "vitthalkasbe@okvks", null);
    ...
    public void deleteEmployeeTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/employees/{id}", 1).header("Authorization", "Basic dXNlcjpwYXNzd29yZA=="))
                .andExpect(status().isOk());
    }
